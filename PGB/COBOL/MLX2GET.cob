CBL TRUNC(OPT),LIST,DATA(31)                                                    
      ...
      *  LANGUAGE  : COBOL II                                                   
      *                                                                         
      *  THIS MODULE WILL CALL THE PARSER TO DO AN INDIVIDUAL GET TO            
      *  A MESSAGE FOR VERSION 1 OR VERSION 2 MESSAGES.                         
      *                                                                         
      *--HISTORY LOG--------------------------------------------------          
      ...
      *----------------------------------------------------------------*        
      ...
      /                                                                         
       ...
       01  FILLER                             PIC X(40) VALUE                   
               '**   MLX2GET  WORKING STORAGE BEGINS  **'.                      
       ...
       01  WS-VARIABLES.                                                        
           ...
           05  WS-CALL-TYPE                 PIC X.                              
               88  WS-CALL-GET            VALUE 'G'.                            
           05  WS-VERSION-X.                                                    
      ...
      ****************************************************************          
       3400-VERSION-2-CALL.                                                     
           ...
           MOVE LENGTH OF AREA2         TO PARS-MAX-LENGTH-AREA2.               
