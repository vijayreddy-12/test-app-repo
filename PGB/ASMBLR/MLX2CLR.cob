CBL TRUNC(OPT),LIST,DATA(31)                                                    
      ...
      *  LANGUAGE  : COBOL II                                                   
      *                                                                         
      *  THIS MODULE WILL CALL THE PARSER TO DO CLEAR CALL TO EITHER            
      *  THE VERSION 1 OR VERSION 2 PARSER.                                     
      *                                                                         
      *--HISTORY LOG--------------------------------------------------          
      ...
      *----------------------------------------------------------------*        
      ...
      /                                                                         
       ...
       01  FILLER                             PIC X(40) VALUE                   
               '**   MLX2CLR  WORKING STORAGE BEGINS  **'.                      
